...
export default function Home() {
    ...
    return (
        <Layout>
            <section className="rounded-3xl bg-blue-600 text-white p-8 md:p-12 shadow-lg mb-10">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {news.map((item) => (
                        <Card key={item.id} title={item.title} date={item.date}>
                            ...
                            <Link to={`/news/${item.id}`} className="text-blue-600 mt-3 inline-block">
                                Lire plus →
                            </Link>
                        </Card>
                    ))}
            ...
            <section>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link to="/hikes" className="text-blue-600 font-medium hover:underline">
